export default function SuccessStoryCard({ story, onSelect }) {
  return (
    ...
    >
      <img src={story.image} alt={story.petName || story.title} className="h-64 w-full object-cover" />
      <div className="p-5">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-brand-pink">{story.date || 'No date'}</p>
